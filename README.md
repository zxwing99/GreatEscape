...
CLASSES:
	...
	- I/O input and output (everyone)
	- Control Panel cordinates all of the classes  (everyone)
	- Intro - graphics of the game introduction (Meera)
	...
	- OpponentType - extend opponent, have different shooting patterns/abilities (movement) (Zachary)
	- LevelMap - map of possible levels (Kathleen)
	- MapView - regulates what part of the LevelMap is currently being played in (Kathleen)

RESPONSIBILITIES:
	- Meera: GameFrame, Intro, Instructions,
	- Zachary: Player/opponents/obstacles 
